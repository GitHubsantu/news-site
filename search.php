        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    ?>
                  <h2 class="page-heading">Top Search : <?php echo $search_term?></h2>
                  ...
                  <?php 
                        ...
                        $offset = ($page - 1) * $limit;
                        $sql = "SELECT post.post_id, post.title, post.post_date, post.description, post.post_img, post.author, category.category_name, user.username, post.category FROM post
