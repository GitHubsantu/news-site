...
switch ($page) {
    ...
    if (isset($_GET['id'])) {
      ...
      $page_title = $website_title ." | ". $row_title['title']." News";
    }else {
    ...
    if (isset($_GET['search'])) {
      $page_title = "Search Result - ". $_GET['search'];
    } else {
      $page_title = "Search Result | No Search Found...!!! ";
    }
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                $result = mysqli_query($conn,$sql) or die ("category connection Failed!!!!!");
                        if (mysqli_num_rows($result) > 0) {
                            $active = "";
                ?>
                <ul class='menu'>
