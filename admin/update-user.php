...
$sql = "UPDATE user SET first_name = '{$f_name}',last_name = '{$l_name}',username = '{$u_name}',role = '{$u_role}' WHERE user_id = {$user_id}";
                  ...
                  <form  action="<?php $_SERVER['PHP_SELF']?>" method ="POST">
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" name="role" value="<?php echo $row['role']; ?>">
                           <?php if ($row['role'] == 1) {
                              echo "<option value='0'>Aurthor</option>
                              <option value='1'selected>Admin</option>";
                            }else {
                              echo "<option value='0'selected>Aurthor</option>
